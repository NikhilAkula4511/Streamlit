...
import pandas as pd
import numpy as np
df1=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\1.ushape.csv',names=["Feature 1", "Feature 2","Class Label"])
df2=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\2.concerticcir1.csv',names=["Feature 1", "Feature 2","Class Label"])
df3=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\3.concertriccir2.csv',names=["Feature 1", "Feature 2","Class Label"])
df4=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\4.linearsep.csv',names=["Feature 1", "Feature 2","Class Label"])
df5=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\5.outlier.csv',names=["Feature 1", "Feature 2","Class Label"])
df6=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\6.overlap.csv',names=["Feature 1", "Feature 2","Class Label"])
df7=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\7.xor.csv',names=["Feature 1", "Feature 2","Class Label"])
df8=pd.read_csv('C:\\Users\\Hello\Deep Learning\\9_Datasets\\8.twospirals.csv',names=["Feature 1", "Feature 2","Class Label"])
